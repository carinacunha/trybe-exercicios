// 1. Qual a ordem de execução do código abaixo?
...
// Ordem de execução será A, B e C

// 2. Qual a ordem de execução do código abaixo?
// const planetDistanceFromSun = ({ name, distanceFromSun: { value, measurementUnit } }) =>
//   `${name} is ${value} ${measurementUnit} apart from the Sun`;
...
//A ordem de execução será A, C e B.
...
//7. Solução não deu certo! Erro no jest.
